  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          backgroundImage: "linear-gradient(var(--sp-grid-line) 1px, transparent 1px), linear-gradient(90deg, var(--sp-grid-line) 1px, transparent 1px)",
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-24">
        <div
          ...
          style={{ background: "var(--sp-step-bg)", borderColor: "var(--sp-btn2-border)", color: "var(--sp-fg)" }}
        >
          <span className="w-2 h-2 rounded-full animate-pulse" style={{ background: "var(--sp-fg)" }} />
        ...
        <div className="mt-20 grid grid-cols-3 gap-6 max-w-md mx-auto">
          {[
            ...
            <div key={stat.label} className="text-center">
              <div className="text-2xl font-bold transition-colors duration-200" style={{ color: "var(--sp-fg)" }}>{stat.value}</div>
              <div className="text-xs mt-1 transition-colors duration-200" style={{ color: "var(--sp-fg-subtle)" }}>{stat.label}</div>
            </div>
          ))}
        </div>
      </div>
